...
# 1 Создание и редактирование инфоблока. Создание и редактирование инфоблока на сайте.
...
# 7 Элементы. Создание элементов на сайте.
...
* 8.4 Если раздел отключен, вне зависимости от активности внутренних элементов, отображаться на сайте как раздел, так и все дочерние элементы не будут.
# 9 Обновление данных.
...
### Образец свойст.
  ![Безымянный13](https://user-images.githubusercontent.com/85296765/124468284-fab04680-dda9-11eb-8698-d63bd76e87ce.png)
...
# 10 Удаление данных. Удаление данных на сайте.
