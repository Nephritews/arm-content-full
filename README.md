...
* 1.1 Откройте страницу, инфоблоки в левом углу в оранжевом круге кнопка с плюсом (нажмите на кнопку плюс, добавить новый раздел). 
![1111](https://user-images.githubusercontent.com/85296765/126149754-ff25cea7-2032-4774-8f3b-a4d478d2a0a2.png)
...
![11](https://user-images.githubusercontent.com/85296765/126149784-e0406d3e-1779-4344-ac22-223e68a94d48.png)
...
![Безымянн44ый](https://user-images.githubusercontent.com/85296765/126147918-32cbb21d-39da-4430-8e8f-0644c8a8a769.png)
...
* 8.1 Поиск элемента. Навигация по списку элементов. Для поиска введите названия элемента в строку поиска (например, некст).
