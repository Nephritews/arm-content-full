...
* 7.8 Оранжевая кнопка с плюсом, добавить новый элемент не использовать.
  ![124233350-d04d5780-db23-11eb-836f-e71b29dfc460](https://user-images.githubusercontent.com/85296765/124872972-f1f08800-dfd6-11eb-932b-89b39d9cb8a9.png)
* 7.9 Поиск элемента. Навигация по списку элементов. Для поиска введите названия элемента в строку поиска (например, терафлекс).
![23](https://user-images.githubusercontent.com/85296765/123264745-61607500-d50b-11eb-8467-dc03ad0adfd6.png)
# 9.0 Активности разделов и элементов. Активности разделов и элементов на сайте.
...
* 9.3 Если поля даты и времени будут пустыми, элемент по умолчанию будет показываться.
![Безымянный11](https://user-images.githubusercontent.com/85296765/124233995-84e77900-db24-11eb-93ca-8bad98ad437a.png)
* 9.4 Если раздел отключен, вне зависимости от активности внутренних элементов, отображаться на сайте как раздел, так и все дочерние элементы не будут.
# 10.0 Обновление данных. Обновление вкладок инфоблока. Обновление вкладок инфоблока на сайте.
...
* 10.1 Для навигации по списку элементов предусмотрена пагинация и поиск элементов.
  ![Безымянный54](https://user-images.githubusercontent.com/85296765/124459004-bd928700-dd9e-11eb-9691-590608fd47ca.png)
* 10.2 При изменение каталогов элементов появляется иконка, указывающая о изменение.
 ![Безымянный24](https://user-images.githubusercontent.com/85296765/124458555-2af1e800-dd9e-11eb-8101-67501871d03c.png)
* 10.3 При редактировании одного и более элементов перед переходом на новую страницу необходимо сохранить все текущие изменения, как показано на рисунке ниже. 
  ![Безымянный23](https://user-images.githubusercontent.com/85296765/124459396-21b54b00-dd9f-11eb-87b9-4574c34ef877.png)
* 10.4 При обновлении списка несохраненные изменения будут потеряны, продолжить? Если хотите сохранить данные нажмите "Отмена" либо не сохранять данные нажмите "ОК".
![Безымянный23](https://user-images.githubusercontent.com/85296765/124457583-01848c80-dd9d-11eb-9fa1-3bd57e1394b9.png)
# 11.0 Удаление данных. Удаление данных на сайте.
* 11.1 Удаление инфоблока. Элементы удаляются по отдельности. Для удаления элемента нужно нажать на иконку корзины с правой стороны от элемента и подтвердить удаление во всплывающем окне.
